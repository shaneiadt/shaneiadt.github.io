---
title: Magic is real with Houdini
date: '2019-03-29'
tags: ['CSS', 'Houdini', 'JavaScript']
draft: false
layout: PostSimple
...
Enter the [Houdini Task Force](https://github.com/w3c/css-houdini-drafts) with one _simple_ goal...outline a collection of drafts to be accepted by [W3C](https://www.w3.org/)  & added as common web standards. Well it doesn't seem that simple but these guys are making great strides for the web and developers sake.

<div className="flex justify-center">![The struggle is real, thanks CSS!](https://media.giphy.com/media/yYSSBtDgbbRzq/giphy.gif "The struggle is real, thanks CSS!")</div>
