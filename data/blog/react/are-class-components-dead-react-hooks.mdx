...
draft: false
layout: PostSimple
summary: 'React Hooks are a new addition in React 16.8 that lets you use state and other React features without writing a class. This article will show you how to use React Hooks to manage state, lifecycle methods & even Context API.'
---
...
![React Hooks](https://cdn-images-1.medium.com/max/2600/1*xcDT-neKHP7E3quS9n30gw.png)
