...
draft: false
layout: PostSimple
summary: "In this article we will continue our journey into understanding Webpack just a wee bit better together! We'll look at setting up a configuration file for our bundler options, multiple entry files & extracting common options to separate files."
---


Welcome to Part 2 of our journey into understanding Webpack just a wee bit better together! If you haven't read [Part 1](https://shaneiadt.github.io/blog/webpack/webpack-4-beginners) I suggest you check it out.
