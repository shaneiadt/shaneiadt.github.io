...
draft: false
layout: PostSimple
summary: "In this article we will run over the basic setup for Webpack 4. Why Webpack & not some other bundler like Parcel or RollUp? I know Webpack so I figured that would be a good start, lets keep it simple shall we!"
---
...
<div className="flex justify-center">![](https://i.imgflip.com/1tlvet.jpg)</div>
